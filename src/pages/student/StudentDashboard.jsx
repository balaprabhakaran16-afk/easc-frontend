...
export default function StudentDashboard() {
  ...
  const calculateAttendance = () => {
    ...
    if (!total || !pres || total <= 0) {
      alert("Enter valid values ❌");
      return;
    }

    if (pres > total) {
      alert("Present cannot be greater than total ❌");
      return;
    }

    const percent = ((pres / total) * 100).toFixed(1);
  ...
  return (
    ...
    <div className="min-h-screen p-10 bg-[#FFFDF5] dark:bg-[#0F172A] text-[#1F2937] dark:text-[#F6E05E] transition-all duration-500">
      ...
      >
        ...
        <h2 className="text-2xl font-semibold mb-4 text-[#F6E05E]">
          Attendance Calculator
        </h2>
        ...
        >
          ...
          {percentage >= 75 ? (
            <p className="text-green-600">
              ✅ Enough attendance for semester
            </p>
          ) : (
            <p className="text-red-600">
              ⚠️ You need to improve the attendance
            </p>
          )}
      ...
      >
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-lg">
          ...
          <h3 className="font-semibold mb-4 text-[#F6E05E]">
            Monthly Attendance %
          </h3>
